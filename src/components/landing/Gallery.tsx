  ...
  return (
    <section id="gallery" className="py-20 px-6 bg-black">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {examples.map((example, index) => (
            <motion.div
              ...
              className="group relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow cursor-pointer bg-zinc-800 border border-zinc-700"
        ...
        >
          <button className="px-8 py-3 bg-white text-black rounded-lg hover:bg-zinc-200 transition font-medium">
            View More Examples
          </button>
        </motion.div>
      </div>
